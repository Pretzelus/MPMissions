...
\n\nGlobal respawn means that a group wich was killed
\nwill respawn in another DAC-camp as long as there is at least one DAC-camp for the given faction.
\n\nIt does not matter where that camp is, because global respawn will pick a random camp as long as respawns are avaible.
...
\n\nIf you are going to kill one of the groups with a click on your mouse, DAC will generate a new group at a random DAC-camp.
