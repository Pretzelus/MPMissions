...
\n\nDAC can generate two more categories:
\nHelicopters and camps.
\n\nThis demonstration will generate one zone with
\n6 choppers and one zone with 2 camps.
...
\n\nIf DAC creates a new chopper that has room for passengers, a new group wich is part of the crew will be created. This new group acts very similar to the group of light vehicles:
...
_text = format["
[Heli-zones and camps]
\n\nA DAC generated chopper has no generated waypoints but a generated spawnlocation.
