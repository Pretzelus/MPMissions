...
\n\nThe action-menu should be pretty self-explanatory. Note: the action menu entry ""...follow player"" means that the zone will follow you and so will the units which are created within the DAC-zone.
...
\n\nPlease note, that there may be some latency.
\n\nWith other words: 
