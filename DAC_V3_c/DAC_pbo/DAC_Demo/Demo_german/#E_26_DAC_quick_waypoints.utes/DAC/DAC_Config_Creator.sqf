...
//===============|=============================================================================================|
	...
	DAC_STRPlayers = ["s1","s2","s3","s4","s5","s6","s7","s8","s9","s10","s11","s12","s13","s14","s15","s16"];
	...
	if(isNil "DAC_Com_Values") 		then {		DAC_Com_Values		= [1,1,0]									};
	...
	if(isNil "DAC_Marker") 			then {		DAC_Marker			= 5											};
	...
	if(isNil "DAC_Auto_UnitCount")	then {		DAC_Auto_UnitCount	= [4,10]									};
	if(isNil "DAC_Player_Support")	then {		DAC_Player_Support	= [10,[6,1000,3]]							};
	...
	DAC_AT_Soldiers		= ["RU_Soldier_AT","USMC_Soldier_AT","GUE_Soldier_AT","CDF_Soldier_RPG","CDF_Soldier_Strela","Ins_Soldier_AT"];
