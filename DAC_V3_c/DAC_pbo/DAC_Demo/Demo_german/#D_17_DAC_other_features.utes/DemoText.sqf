...
\n\nIm Suedosten der Karte befinden sich z.B. 4 Zonen, die wie oben beschrieben, ineinander platziert wurden. Jede dieser Zonen besitzt eine Logik, die etwas bewirkt:
...
\n\nNameDerLogik setvariable [""Link"", NameDerZone]
"];
