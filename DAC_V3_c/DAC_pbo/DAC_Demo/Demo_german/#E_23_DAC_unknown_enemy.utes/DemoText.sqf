...
_text = format["
[Unbekannter Feind]
\n\nBis jetzt waren bei jeder Demo die DAC-Marker aktiv, und Du konntest genau feststellen, was DAC generiert hat. Die DAC-Marker sind primaer dafuer gedacht, Dir bei der Missionserstellung soviel DAC-Daten wie moeglich zu liefern.
