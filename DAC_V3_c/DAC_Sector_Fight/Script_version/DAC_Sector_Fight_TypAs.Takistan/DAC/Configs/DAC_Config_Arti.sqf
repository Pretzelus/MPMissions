...
//-------------------------------------------------------------------------------------------------------------------------
	...
	{		
		_set0  = [20,2,0,60];
		_set1  = [3,0.2,100,[],2,30];
		_set2  = [100,100,50,500,4,1,1];
		_set3  = [["D30_TK_GUE_EP1",["Sh_122_HE"]],["T72",["Sh_105_HE"]]];
		_set4  = [5,5,1];
		_set5  = [10,30,1];
		_set6  = [10,30,1];
		_set7  = [0.1,0.5,1];
...
//-------------------------------------------------------------------------------------------------------------------------
	case 2:
	{
		...
		_set1  = [3,0.2,100,[],2,30];
		_set2  = [100,100,50,500,4,1,1];
		_set3  = [["M119_US_EP1",["Sh_105_HE"]],["M1A1",["Sh_105_HE"]]];
		_set4  = [5,5,1];
		_set5  = [10,30,1];
		_set6  = [10,30,1];
		_set7  = [0.1,0.5,1];
...
//-------------------------------------------------------------------------------------------------------------------------
	...
	{		
		...
		_set3  = [["D30_TK_GUE_EP1",["Sh_122_HE"]],["T72_INS",["Sh_125_SABOT"]]];
		_set4  = [2,5,1];
		_set5  = [10,30,1];
		_set6  = [10,30,1];
		_set7  = [0.1,0.5,1];
